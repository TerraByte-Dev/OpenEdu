...
export const SPRITE_PERSONAS: SpritePersona[] = [
  {
    ...
    displayName: "SAGE",
    imagePath: sageUrl,
    blurb: "Plain language, one idea at a time — defines terms and checks you are with it. Any subject.",
    domainHints: [],
  },
  {
    id: "euler",
    displayName: "EULER",
    imagePath: eulerUrl,
    blurb: "Step by visible step — given, wanted, and the shortest honest route. Math, physics & engineering.",
  ...
  },
  {
    ...
    displayName: "ADA-9",
    imagePath: adaUrl,
    blurb: "Takes it apart — what the code does vs what you expected, with a small runnable example.",
  ...
  },
  {
    ...
    displayName: "LINGO-3",
    imagePath: lingoUrl,
    blurb: "Teaches through use — an example first, then the pattern, then something to try. Languages.",
  ...
  },
  {
    ...
    displayName: "NOVA",
    imagePath: novaUrl,
    blurb: "Starts from something you can observe, then names the principle behind it. Science.",
  ...
  },
  {
    ...
    displayName: "TEMPO",
    imagePath: musicUrl,
    blurb: "Connects notation to sound — what it would sound like, and where you have heard it. Music.",
